...
import { RUN_MODES, ASCENSION_LEVELS, ASCENSION_MODIFIER_INFO, getRunModeConfig, getAscensionLevel } from '../ascensionData';
...
export const RunModeScreen: React.FC<RunModeScreenProps> = ({
  ...
  const selectedModeConfig = getRunModeConfig(selectedMode)!;
  const selectedAscensionData = getAscensionLevel(selectedAscension);
            ...
            <div>
              ...
              <div className="grid grid-cols-5 gap-1 mb-4">
                {Array.from({ length: 20 }, (_, i) => i + 1).map((level) => {
                  ...
                  const ascData = getAscensionLevel(level);
