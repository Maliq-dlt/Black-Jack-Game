...
// --- Persistence (Moved outside component to prevent recreation and allow lazy initialization) ---
...
const App: React.FC = () => {
  // --- State ---
  // Lazy initialize gameState to avoid synchronous localStorage hits on every render
  ...
  const [lifetimeStats, setLifetimeStats] = useState<LifetimeStats>(loadStats); // React lazy initial state
