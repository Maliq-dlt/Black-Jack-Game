...
// ⚡ Bolt Optimization: Moved localStorage reads outside the component to avoid redefining them on every re-render.
// --- Persistence ---
...
const App: React.FC = () => {
  ...
  // ⚡ Bolt Optimization: Lazy state initialization for stats to prevent redundant localStorage reads
