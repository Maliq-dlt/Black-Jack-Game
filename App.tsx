...
const App: React.FC = () => {
  ...
  const handleCoinsComplete = useCallback(() => setShowCoins(false), []);
  ...
  return (
    ...
    >
      ...
      {/* Particle Effects */}
      <ParticleEffect type="confetti" trigger={showConfetti} onComplete={handleConfettiComplete} />
      <ParticleEffect type="coins" trigger={showCoins} onComplete={handleCoinsComplete} />
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex items-center justify-center">
                    <AnimatePresence>
                        {gameState.currentBetChips.map((chip, index) => (
                            ...
                            >
                                <Chip color={chip.color} value={chip.value} onClick={NO_OP} />
                            </motion.div>
                        ))}
                    </AnimatePresence>
                </div>
