...
const App: React.FC = () => {
  // --- State ---
  // ⚡ Bolt: Using lazy initialization for gameState and lifetimeStats prevents
  // expensive synchronous localStorage.getItem calls from executing on every React render.
  ...
  // ⚡ Bolt: Lazy state initialization for stats to prevent re-reading localStorage
