...
// --- Persistence ---
// Moved outside component to avoid recreation on each render and enable lazy initialization
...
const App: React.FC = () => {
  ...
  // --- State ---
  // Lazy state initialization to prevent synchronous localStorage reading on every render
